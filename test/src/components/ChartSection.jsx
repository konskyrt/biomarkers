...
export default function ChartSection() {
  ...
  const chartData = {
    ...
    datasets: [
      { label: 'H: Heizung', data: mockData.series.Heizung, borderColor: '#F44336', backgroundColor: 'rgba(244, 67, 54, 0.1)', tension: 0.4 },
      { label: 'S: Sanitär', data: mockData.series.Sanitär, borderColor: '#2196F3', backgroundColor: 'rgba(33, 150, 243, 0.1)', tension: 0.4 },
      { label: 'L: Lüftung', data: mockData.series.Lüftung, borderColor: '#4CAF50', backgroundColor: 'rgba(76, 175, 80, 0.1)', tension: 0.4 },
      { label: 'E: Elektro', data: mockData.series.Elektro, borderColor: '#FFEB3B', backgroundColor: 'rgba(255, 235, 59, 0.1)', tension: 0.4 }
    ]
  };
  ...
  return (
    <div className="bg-white shadow rounded-lg p-4">
      <h3 className="text-lg font-medium mb-4">Zeitverlauf Materialmenge pro Gewerk</h3>
      <div className="h-80">
